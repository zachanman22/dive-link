...
public:
    ...
    */
    ...
    static const int number_of_fh_pairs = 6;
    // should change to once frequency per line
    float fhfsk_data[number_of_fh_pairs][number_of_symbols * 4] = {{25000, 0, 0, 0.65, 33000, 0, 0, 0.45},
                                                                   {28000, 0, 0, 0.4, 36000, 0, 0, 0.45},
                                                                   {26000, 0, 0, 0.4, 34500, 0, 0, 0.5},
                                                                   {30000, 0, 0, 0.4, 36500, 0, 0, 0.6},
                                                                   {27000, 0, 0, 0.3, 35500, 0, 0, 0.55},
                                                                   {32500, 0, 0, 0.3, 42000, 0, 0, 0.8}};
