...
if __name__ == '__main__':
    # quick test
    fileName = "60_80k____sampleK_500_all_G"
    ...
    transmission = data[1546000:2128000] / 1000
    ...
    shift = -10
    startIndex = 0
    while startIndex > -1095: 
        while bit <= 256:
            transmission = data[1546000+startIndex:2128000+startIndex] / 1000
            #indices
